...
MoviesNowPlayingDTO moviesNowPlayingDtoFromJson(String str) =>
    MoviesNowPlayingDTO.fromJson(json.decode(str));

String moviesNowPlayingDtoToJson(MoviesNowPlayingDTO data) =>
    json.encode(data.toJson());

class MoviesNowPlayingDTO {
  MoviesNowPlayingDTO({
    this.page,
    this.results,
    this.dates,
  ...
  factory MoviesNowPlayingDTO.fromJson(Map<String, dynamic> json) =>
      MoviesNowPlayingDTO(
        page: json["page"],
